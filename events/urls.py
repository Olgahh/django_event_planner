...
from .views import Login, Logout, Signup, home, event_list, event_detail, create_event,event_update, book_event,profile_view
...
urlpatterns = [
    ...
    path('profile/update/<int:event_id>', event_update, name='profile-update'),
